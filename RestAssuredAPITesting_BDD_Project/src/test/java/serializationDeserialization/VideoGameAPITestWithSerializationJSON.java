...
public class VideoGameAPITestWithSerializationJSON {
	...
	public void testVideoVideoGameDeSerialization() {
		...
		VideoGame myVideoGame = get("http://localhost:8080/app/videogames/12").as(VideoGame.class); //This response of [get("http://localhost:8080/app/videogames/11")] has to be converted into the object typ[VideoGame.class].
